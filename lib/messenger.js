...
export default class Messenger {
     ...
     * facility. By default uses the 'CLOUD_DATA_TOPIC' environment variable,
     * but subclasses may override as needed.
     */
    createDataTopic() {
        return process.env.CLOUD_DATA_TOPIC
    }
...
class GcpMessenger extends Messenger {
    ...
    createDataTopic() {
        return `${process.env.GCP_DATA_TOPIC_ROOT}/${process.env.CLOUD_DATA_TOPIC}`
    }
